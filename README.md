...
Retrieve and consume JSON components for proprietary CMS for hospitals.

The use case for this project is New York Presbyterian.

I designed components in Sketch that when approved needed to be styled using JSON syntax for use in internal CMS.
